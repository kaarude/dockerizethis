...
- Pass `verify.Build`'s returned image to `verify.Smoke` through
  `Extras["verifyImage"]` on a copy of the plan. Keep this runtime value out of
  the reported detection plan.
