...
root. Web images set `ASPNETCORE_URLS=http://+:PORT` for the selected port,
including older base images. `Extras["targetFramework"]` selects the matching
framework when publishing a project with multiple targets.
